...
![high level pairing flow](Security-in-Bluetooth-Low-Energy/high_level_pairing_flow.png)
...
![smp request](Security-in-Bluetooth-Low-Energy/smp_request.png)
...
![le legacy pairing](Security-in-Bluetooth-Low-Energy/le_legacy_pairing.png)
...
![c1 function](Security-in-Bluetooth-Low-Energy/c1_function.jpg)
...
![le sc](Security-in-Bluetooth-Low-Energy/le_sc.png)
...
![out of band part](Security-in-Bluetooth-Low-Energy/out_of_band_part.png)

The Out of Band Part

![in band part](Security-in-Bluetooth-Low-Energy/in_band_part.png)
...
![starting encryption during pairing after an insufficient encryption error](Security-in-Bluetooth-Low-Energy/starting_encryption.png)
...
![session key creation](Security-in-Bluetooth-Low-Energy/session_key_creation.png)
...
![encryption start](Security-in-Bluetooth-Low-Energy/encryption_start.png) 

#### 2.2.2 Encryption and Authentication of Link Data

BLE使用AES-CCM来进行加密。

![encrypted pdu layer](Security-in-Bluetooth-Low-Energy/encrypted_pdu_layer.png)
...
#### 2.2.3 Verifying the On-Going Integrity of the Encrypted Link
...
![non-resolvable private address](Security-in-Bluetooth-Low-Energy/non-resolvable_private_address.png)

resolvable:最高2位是0和1，接着的22位是随机数prand，剩下的24位是用IRK和prand计算得到的hash。

![resolvable private address](Security-in-Bluetooth-Low-Energy/resolvable_private_address.png)
